...
if __name__=="__main__":
    ...
    print("\n=========================")
    print("INITIAL PLAYER OBSERVATION")
    print(vec_obs)
    print("===========================\n")
    ...
    action, move_dict = agent_test.act(vec_obs)
    #print(action)
    ...
    while not is_done:
        ...
        print("\n")
        print("TMP PLAYER VIEW ON LAST ACTIONS")
        ...
        if current_player in has_played:
          ...
          action, move_dict = agent_test.act(current_player_observation)
